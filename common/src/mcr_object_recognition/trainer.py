...
if __name__ == "__main__":
    ...
    [predicted_labels,probabilities] = test.classfiy_test_file(test_features)
    print "Testing complete, here are the results:"

    for i in range(len(predicted_labels)):
        print "Predicted Label " , i, " : ",predicted_labels[i]," with prob ", probabilities[i], " True label : " , true_labels[i] 
